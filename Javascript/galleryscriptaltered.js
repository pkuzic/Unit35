	//	alert("in the js file >> " + number_of_journals);
	
	//for(var i=0;i<journal_array_name.length;i++)
	//{
	//	alert("in the js file >> " + journal_array_image[i] + " >> " + journal_array_name[i]);
	//}
	
	var imageData= [];									//		was new Array(10);		// Define an array to contain the image data
	createTwoDimensionalArray(3);		// call function 
	var initialvalue = 0;

	// Image path data

	for(var i=0;i<number_of_journals;i++)
	{
